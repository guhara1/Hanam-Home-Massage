...
_breadcrumb_schema = {
    ...
    "itemListElement": [
        ...
        {"@type": "ListItem", "position": 2, "name": "하남 출장마사지", "item": _BASE + "/gyeonggi/hanam/"},
    ],
}
...
_HERO = """<div class="hero">
  <div class="hero-content">
    ...
    <div class="hero-cta">
      ...
      <a href="/gyeonggi/hanam/reservation/" class="btn btn-secondary">예약 안내 보기</a>
      <a href="/gyeonggi/hanam/check/" class="btn btn-secondary">이용 전 확인사항</a>
    </div>
  </div>
...
<section id="areas">
  ...
  <div class="card-grid">
    <a href="/gyeonggi/hanam/misa-area/" class="card"><h3>미사 생활권</h3><p>미사역, 미사강변도시, 망월동, 선동 인접 생활권</p><span class="card-arrow">→</span></a>
    <a href="/gyeonggi/hanam/mangwol-dong/" class="card"><h3>망월동</h3><p>미사역, 미사강변도시, 한강변 주거지 생활권</p></a>
    <a href="/gyeonggi/hanam/seon-dong/" class="card"><h3>선동</h3><p>미사강변도시, 망월동, 미사역 인접 생활권</p></a>
    <a href="/gyeonggi/hanam/pungsan-dong/" class="card"><h3>풍산동</h3><p>하남풍산역, 미사, 덕풍동 인접 생활권</p></a>
    <a href="/gyeonggi/hanam/deokpung-dong/" class="card"><h3>덕풍동</h3><p>하남풍산역, 덕풍시장, 신장동 인접 생활권</p></a>
    <a href="/gyeonggi/hanam/sinjang-dong/" class="card"><h3>신장동</h3><p>하남시청역, 스타필드 하남, 창우동 인접 생활권</p></a>
    <a href="/gyeonggi/hanam/changu-dong/" class="card"><h3>창우동</h3><p>하남검단산역, 검단산, 신장동 인접 생활권</p></a>
    <a href="/gyeonggi/hanam/cheonhyeon-dong/" class="card"><h3>천현동</h3><p>검단산, 창우동, 배알미동 인접 차량 이동 생활권</p></a>
    <a href="/gyeonggi/hanam/gamil-dong/" class="card"><h3>감일동</h3><p>감일지구, 감이동, 위례·송파 인접 생활권</p></a>
    <a href="/gyeonggi/hanam/gambuk-dong/" class="card"><h3>감북동</h3><p>감북동, 초이동, 강동 상일동 인접 생활권</p></a>
    <a href="/gyeonggi/hanam/wirye-dong/" class="card"><h3>위례동</h3><p>하남 위례, 학암동, 감일동 인접 생활권</p></a>
    <a href="/gyeonggi/hanam/chungung-dong/" class="card"><h3>춘궁동</h3><p>교산동, 춘궁동, 상사창동, 하사창동 인접 생활권</p></a>
    <a href="/gyeonggi/hanam/choi-dong/" class="card"><h3>초이동</h3><p>초이동, 초일동, 감북동, 강동 인접 생활권</p></a>
    <a href="/gyeonggi/hanam/misa-dong/" class="card"><h3>미사동</h3><p>미사강변도시 생활권 행정 중심 안내</p></a>
  </div>
</section>
...
<section id="stations">
  ...
  <div class="card-grid">
    <a href="/gyeonggi/hanam/station/misa-station/" class="card"><h3>미사역</h3><p>망월동, 미사강변도시, 선동 인접 생활권입니다. 방문 주소와 건물 출입 가능 여부를 먼저 확인하세요.</p><span class="card-arrow">상세보기 →</span></a>
    <a href="/gyeonggi/hanam/station/hanam-pungsan-station/" class="card"><h3>하남풍산역</h3><p>풍산동, 덕풍동 인접 생활권입니다. 예약 가능 시간과 방문 주소를 먼저 확인하세요.</p><span class="card-arrow">상세보기 →</span></a>
    <a href="/gyeonggi/hanam/station/hanam-cityhall-station/" class="card"><h3>하남시청역</h3><p>신장동, 덕풍동, 창우동 인접 생활권입니다. 자택·숙소·오피스텔 이용 가능 여부를 먼저 확인하세요.</p><span class="card-arrow">상세보기 →</span></a>
    <a href="/gyeonggi/hanam/station/hanam-geomdansan-station/" class="card"><h3>하남검단산역</h3><p>창우동, 천현동, 검단산 인접 생활권입니다. 차량 이동 기준과 추가 이동비 여부를 확인하세요.</p><span class="card-arrow">상세보기 →</span></a>
    <a href="/gyeonggi/hanam/station/gangil-nearby-area/" class="card"><h3>강일역 인접</h3><p>미사·감북 인접 이동 기준 안내</p></a>
    <a href="/gyeonggi/hanam/station/sangil-dong-nearby-area/" class="card"><h3>상일동역 인접</h3><p>초이·감북 인접 이동 기준 안내</p></a>
    <a href="/gyeonggi/hanam/station/macheon-nearby-area/" class="card"><h3>마천역 인접</h3><p>감일·하남 위례 인접 이동 기준 안내</p></a>
    <a href="/gyeonggi/hanam/station/dunchon-oryun-nearby-area/" class="card"><h3>둔촌오륜역 인접</h3><p>감일 인접 이동 기준 안내</p></a>
  </div>
</section>
...
<section id="lifestyle">
  ...
  <div class="card-grid">
    <a href="/gyeonggi/hanam/area/misa-riverside-city/" class="card">미사강변도시</a>
    <a href="/gyeonggi/hanam/area/misa-station-mangwol/" class="card">미사역·망월동</a>
    <a href="/gyeonggi/hanam/area/hanam-pungsan-deokpung/" class="card">하남풍산·덕풍</a>
    <a href="/gyeonggi/hanam/area/hanam-cityhall-sinjang/" class="card">하남시청·신장</a>
    <a href="/gyeonggi/hanam/area/geomdansan-changu/" class="card">하남검단산·창우</a>
    <a href="/gyeonggi/hanam/area/starfield-sinjang/" class="card">스타필드·신장</a>
    <a href="/gyeonggi/hanam/area/gamil-district/" class="card">감일지구</a>
    <a href="/gyeonggi/hanam/area/hanam-wirye/" class="card">하남 위례</a>
    <a href="/gyeonggi/hanam/area/gambuk-choi/" class="card">감북·초이</a>
    <a href="/gyeonggi/hanam/area/chungung-gyosan/" class="card">춘궁·교산</a>
    <a href="/gyeonggi/hanam/area/cheonhyeon-geomdansan/" class="card">천현·검단산</a>
    <a href="/gyeonggi/hanam/area/paldang-baealmi-nearby/" class="card">팔당·배알미 인접</a>
    <a href="/gyeonggi/hanam/area/gangdong-gamil-nearby/" class="card">강동·감일 인접</a>
  </div>
</section>

<section id="check">
  <h2>하남 홈타이 예약 전 확인사항</h2>
  <p>예약을 진행하기 전에 다음 항목을 먼저 확인하면 방문 일정이 정확해집니다. 자세한 내용은 <a href="/gyeonggi/hanam/check/">이용 전 확인사항</a>에서 확인하세요.</p>
  <ul>
    ...
    <li><strong>개인정보 처리 기준 확인</strong> — <a href="/gyeonggi/hanam/support/privacy/">개인정보처리방침</a> 참조</li>
...
<section id="faq">
  ...
  <dl class="faq-list">
    ...
    <dd>1차 안내에서는 <a href="/gyeonggi/hanam/misa-area/">미사 생활권</a>으로 묶어 안내합니다. 미사강변도시, 망월동, 선동, 풍산동 인접권을 함께 설명하므로 미사 생활권 페이지에서 방문 가능 지역을 확인하는 방식이 좋습니다.</dd>

    <dt id="faq-3">위례동은 송파 위례와 같은 지역인가요?</dt>
    <dd>위례는 하남·송파·성남으로 행정구역이 나뉩니다. 본 안내는 <a href="/gyeonggi/hanam/wirye-dong/">하남 위례</a> 기준이며, 송파 위례·성남 위례는 별도 행정구역이므로 인접 생활권으로만 설명합니다.</dd>
